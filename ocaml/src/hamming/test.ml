...
let tests =
  [
    "empty strands" >:: ae (Ok 0) (hamdist "" "");
    "single letter identical strands" >:: ae (Ok 0) (hamdist "A" "A");
    "single letter different strands" >:: ae (Ok 1) (hamdist "G" "T");
    "long identical strands"
    >:: ae (Ok 0) (hamdist "GGACTGAAATCTG" "GGACTGAAATCTG");
    "long different strands"
    >:: ae (Ok 9) (hamdist "GGACGGATTCTG" "AGGACGGATTCT");
    "disallow first strand longer"
    >:: ae (Error "left and right strands must be of equal length")
          (hamdist "AATG" "AAA");
